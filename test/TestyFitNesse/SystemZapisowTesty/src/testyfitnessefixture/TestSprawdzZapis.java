 ...
 * @author Qucker135
 */
public class TestSprawdzZapis extends ColumnFixture{
    String dane[];
    
    public boolean SprawdzZapis() /*throws IllegalFormatCodePointException*/{
        int s1=liczbaGrup();
        try{
            if(dane.length<2) throw new IllegalFormatCodePointException(0);
            
            SetUp.aplikacja_studenta.sprawdzZapis(dane[0], dane[1], SetUp.katalog);
